...
var STRIPE_PUBLIC_KEY = "pk_test_4wpDbRpfgtxLW0JHXwHPnC7n00M0KnKoYv";
...
function calculateDisplayAmountFromCurrency(content) {
  var amountToDisplay = content.amount;

  if (zeroDecimalCurrencies(content.currency) === -1) {
...
function create(content) {
  var amount = calculateDisplayAmountFromCurrency(content);
  ...
  <div class="ElementsModal--top-banner">
    <div class="ElementsModal--sales-info">
      <div class="ElementsModal--top">
        ...
        <button type="button" aria-label="Close modal" class="ElementsModal--close btn-link" onClick="window.elementsModal.show()">
        <!-- SVG close button for modal -->
          <svg
            width="20px"
            height="20px"
            viewBox="0 0 20 20"
  ...
  <div class="ElementsModal--payment-details">
    <!-- 
               Edit the action URL here to correspond with where 
               you want the POST request to your server to go. 
          -->
    <form
